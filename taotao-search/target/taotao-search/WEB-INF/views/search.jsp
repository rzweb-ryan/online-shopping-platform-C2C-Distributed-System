...
<link rel="stylesheet" type="text/css" href="http://static.taotao.rzweb.us/css/base.css" media="all" />
<link rel="stylesheet" type="text/css" href="http://static.taotao.rzweb.us/css/psearch20131008.css" media="all" />
<link rel="stylesheet" type="text/css" href="http://static.taotao.rzweb.us/css/psearch.onebox.css" media="all" />
<link rel="stylesheet" type="text/css" href="http://static.taotao.rzweb.us/css/pop_compare.css" media="all" />
<script type="text/javascript" src="http://static.taotao.rzweb.us/js/jquery-1.2.6.min.js"></script>
</head>
<body>
<script type="text/javascript" src="http://static.taotao.rzweb.us/js/base-2011.js" charset="utf-8"></script>
<!-- header start -->
...
<li class="item-book" bookid="11078102">
	<div class="p-img">
		<a target="_blank" href="http://www.taotao.rzweb.us/item/${item.id }.html">
	...
	<div class="p-price">
		<i>淘淘价：</i>
		<%--<strong>￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value= "${item.price / 1000}" type="number"/></strong>--%>
	</div>
...
<!-- footer end -->
<script type="text/javascript" src="http://static.taotao.rzweb.us/js/jquery.hashchange.js"></script>
<script type="text/javascript" src="http://static.taotao.rzweb.us/js/search_main.js"></script>
