...
<head>
    ...
    <title>注册-个人用户</title>
    <link type="text/css" rel="stylesheet" href="http://static.taotao.rzweb.us/css/regist.personal.css"/>
    <link type="text/css" rel="stylesheet" href="http://static.taotao.rzweb.us/css/passport.base.css"/>
...
<div class="w" id="logo">
    <div>
    	<a href="http://www.taotao.com/">
    		<img src="http://static.taotao.rzweb.us/images/taotao-logo.gif" alt="淘淘商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    ...
    <div class="mc">
        <form id="personRegForm" method="POST" onsubmit="return false;">
            ...
            <div class="phone">
                <img width="180" height="180" src="http://static.taotao.rzweb.us/images/phone-bg.jpg">
            </div>
                        <span class="clr"></span>
        </form>
    </div>
...
<script type="text/javascript" src="http://static.taotao.rzweb.us/js/register/jd.lib.js"></script>
<script type="text/javascript" src="http://static.taotao.rzweb.us/js/register/jdThickBox.js"></script>
<script type="text/javascript" src="http://static.taotao.rzweb.us/js/register/jdValidate.js"></script>
<script type="text/javascript" src="http://static.taotao.rzweb.us/js/register/jdValidate.emReg.js"></script>
<script type="text/javascript" src="http://static.taotao.rzweb.us/js/register/jdValidate.regSuccess.js"></script>
