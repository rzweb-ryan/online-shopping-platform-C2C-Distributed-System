...
import us.rzweb.taotao.manage.bean.PicUploadResult;
...
public class UploadController {
    ...
    public String upload(@RequestParam("uploadFile") MultipartFile uploadFile, HttpServletResponse response)
        ...
        // 生成图片的绝对引用地址
        String picUrl = StringUtils.substringAfter(filePath, REPOSITORY_PATH);
        fileUploadResult.setUrl(IMAGE_UPLOAD_URL + picUrl);
